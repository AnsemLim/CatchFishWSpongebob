...
namespace CatchFishGame {
    ...
    public partial class gamedbDataSet : global::System.Data.DataSet {
        ...
        public partial class PlayerDataTable : global::System.Data.TypedTableBase<PlayerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public PlayerRow AddPlayerRow(int ID, string PlayerName, int Score, int Time) {
        ...
        public partial class PlayerRow : global::System.Data.DataRow {
            ...
            public int Time {
                get {
                    try {
                        return ((int)(this[this.tablePlayer.TimeColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Time\' in table \'Player\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tablePlayer.TimeColumn] = value;
                }
            }
            ...
            public bool IsTimeNull() {
                return this.IsNull(this.tablePlayer.TimeColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetTimeNull() {
                this[this.tablePlayer.TimeColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace CatchFishGame.gamedbDataSetTableAdapters {
    ...
    public partial class PlayerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Player` WHERE ((`ID` = ?) AND ((? = 1 AND `PlayerName` IS NULL) OR (" +
                "`PlayerName` = ?)) AND ((? = 1 AND `Score` IS NULL) OR (`Score` = ?)) AND ((? = " +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Player` (`PlayerName`, `Score`, `Time`) VALUES (?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Player` SET `PlayerName` = ?, `Score` = ?, `Time` = ? WHERE ((`ID` = ?) A" +
                "ND ((? = 1 AND `PlayerName` IS NULL) OR (`PlayerName` = ?)) AND ((? = 1 AND `Sco" +
                "re` IS NULL) OR (`Score` = ?)) AND ((? = 1 AND `Time` IS NULL) OR (`Time` = ?)))" +
                "";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CatchFishGame.Properties.Settings.Default.gamedbConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, PlayerName, Score, [Time] FROM Player";
        ...
        public virtual int Fill(gamedbDataSet.PlayerDataTable dataTable) {
        ...
        public virtual gamedbDataSet.PlayerDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            gamedbDataSet.PlayerDataTable dataTable = new gamedbDataSet.PlayerDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(gamedbDataSet.PlayerDataTable dataTable) {
        ...
        public virtual int Delete(int Original_ID, string Original_PlayerName, global::System.Nullable<int> Original_Score, global::System.Nullable<int> Original_Time) {
        ...
        public virtual int Insert(string PlayerName, global::System.Nullable<int> Score, global::System.Nullable<int> Time) {
            if ((PlayerName == null)) {
        ...
        public virtual int Update(string PlayerName, global::System.Nullable<int> Score, global::System.Nullable<int> Time, int Original_ID, string Original_PlayerName, global::System.Nullable<int> Original_Score, global::System.Nullable<int> Original_Time) {
            if ((PlayerName == null)) {
